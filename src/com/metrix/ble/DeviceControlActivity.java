...
public class DeviceControlActivity extends Activity {
            ...
            new ExpandableListView.OnChildClickListener() {
                ...
                public boolean onChildClick(ExpandableListView parent, View v, int groupPosition,
                	...
                	if (mGattCharacteristics != null) {
                		...
                		Log.i(TAG, "chara can read: " + String.valueOf(charaProp & BluetoothGattCharacteristic.PROPERTY_READ));
                		Log.i(TAG, "chara can write: " + String.valueOf(charaProp & BluetoothGattCharacteristic.PROPERTY_WRITE));
                		Log.i(TAG, "chara can notify: " + String.valueOf(charaProp & BluetoothGattCharacteristic.PROPERTY_NOTIFY));
                		...
                		// read the characteristic, or set it to notify us
    ...
    // Long click allows write
    private final ExpandableListView.OnItemLongClickListener servicesListLongClickListner =
    ...
    private void displayGattServices(List<BluetoothGattService> gattServices) {
        if (gattServices == null) {
        	Log.d(TAG,  "no gatt services to display");
        	return;
        }
        String uuid = null;
        ...
        for (BluetoothGattService gattService : gattServices) {
        	Log.d(TAG, "looking at gatt service " + gattService.getUuid().toString());
